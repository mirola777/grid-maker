...
const translations = {
  en: {
    ...
    historyEmpty: "No saved grids yet",
    historyEmptySub: "Your grids will appear here when you save them",
    historyLoad: "Load",
    historyUntitled: "Untitled",
    historyRename: "Rename",
    historyDelete: "Delete",
    historyClearAll: "Clear all history",
    historyConfirmClear: "Tap again to confirm",
    historyNamePlaceholder: "Grid name...",
  ...
  es: {
    ...
    historyEmpty: "Sin grids guardados",
    historyEmptySub: "Tus grids aparecerán aquí cuando los guardes",
    historyLoad: "Cargar",
    historyUntitled: "Sin nombre",
    historyRename: "Renombrar",
    historyDelete: "Eliminar",
    historyClearAll: "Borrar todo el historial",
    historyConfirmClear: "Toca otra vez para confirmar",
    historyNamePlaceholder: "Nombre del grid...",
    historyJustNow: "ahora",
    historySave: "Guardar en historial",
  ...
  pt: {
    ...
    historyEmpty: "Nenhum grid salvo",
    historyEmptySub: "Seus grids aparecerão aqui quando você salvá-los",
    historyLoad: "Carregar",
    historyUntitled: "Sem nome",
    historyRename: "Renomear",
    historyDelete: "Excluir",
    historyClearAll: "Limpar todo o histórico",
    historyConfirmClear: "Toque novamente para confirmar",
    historyNamePlaceholder: "Nome do grid...",
    historyJustNow: "agora",
    historySave: "Salvar no histórico",
  ...
  fr: {
    ...
    historyEmpty: "Aucune grille sauvegardée",
    historyEmptySub: "Vos grilles apparaîtront ici quand vous les sauvegarderez",
    historyLoad: "Charger",
    historyUntitled: "Sans nom",
    historyRename: "Renommer",
    historyDelete: "Supprimer",
    historyClearAll: "Effacer tout l'historique",
    historyConfirmClear: "Appuyez à nouveau pour confirmer",
    historyNamePlaceholder: "Nom de la grille...",
    historyJustNow: "maintenant",
    historySave: "Sauvegarder dans l'historique",
